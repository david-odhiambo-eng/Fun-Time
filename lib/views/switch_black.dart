...
class SwitchBlackScreen extends StatefulWidget {
  final int teamNo;
  const SwitchBlackScreen ({super.key, required this.teamNo});

  @override
  _BlackCardScreenState createState() => _BlackCardScreenState();
}

class _BlackCardScreenState extends State<SwitchBlackScreen >
